export NCGBFGSOptimizer

@with_kw mutable struct NCGBFGSOptimizer <: AbstractOptimizer
...
function setOptions!(opt::NCGBFGSOptimizer; 
...
function (opt::NCGBFGSOptimizer)(f::Function, g!::Function, x0::Array{Float64,1})
    x = x0 
    α0 = 1.0
